...
import { PiHeartStraightBold, PiTagBold, PiUsersThreeBold } from "react-icons/pi";
...
const Navbar = () => {
    ...
    return (
        <div className="max-w-[1640px] lg:mx-20 flex justify-between items-center p-4">
        {/* Left Side */}
            ...
            {/* Search input */}
            <div className="bg-gray-200 rounded-full flex items-center px-4 w-[200px] sm:w-[400px] lg:w-[500px]">
                ...
                <AiOutlineClose
                    ...
                    <nav>
                        <ul className="flex flex-col p-4 text-gray-700">
                            ...
                            <li className="text-xl py-4 flex"><PiHeartStraightBold
                            size={25} className="mr-4" />Favorites</li>
                            <li className="text-xl py-4 flex"><LuWallet
                            size={25} className="mr-4" />Wallet</li>
                            <li className="text-xl py-4 flex"><BiHelpCircle
                            size={25} className="mr-4" />Help</li>
                            <li className="text-xl py-4 flex"><PiTagBold
                            size={25} className="mr-4" />Promotions</li>
                            <li className="text-xl py-4 flex"><HiOutlineSave
                            size={25} className="mr-4" />Best Ones</li>
                            <li className="text-xl py-4 flex"><PiUsersThreeBold
